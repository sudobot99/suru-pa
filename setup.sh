...
echo ""
echo -e "${YELLOW}Next: Run OpenClaw onboarding${NC}"
echo "  openclaw onboard"
echo ""
echo "  This wizard will configure your API keys, gateway service,"
echo "  messaging channels, and skills — all in one step."
echo ""
